...
import com.androidjson.inbox.databinding.ActivityQuestFBinding;
...
public class QuestFActivity extends BaseActivity
{
    ActivityQuestFBinding binding;
    Toolbar toolbar;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_quest_f);
    ...
    public void getDateFact(View v)
    {
        ...
        {
            if (Utils.isNetworkAvailable(QuestFActivity.this))
            {
                if (dateCalled)
                {
                    ...
                    public void onResponse(Call<FactResponse> call, Response<FactResponse> response)
                    {
                        if (response != null && response.isSuccessful())
                        {
                            ...
                            } else
                            {
                                ...
                                hideFab();
                                Toast.makeText(QuestFActivity.this, "Please try different date", Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                ...
                if (Utils.isNetworkAvailable(QuestFActivity.this))
                {
                    ...
                    apiCall.enqueue(new Callback<FactResponse>()
                    {
                        ...
                        public void onResponse(Call<FactResponse> call, Response<FactResponse> response)
                        {
                            if (response != null && response.isSuccessful())
                            {
                                ...
                                } else
                                {
                                    ...
                                    hideFab();
                                    Toast.makeText(QuestFActivity.this, R.string.please_try_different_number, Toast.LENGTH_LONG).show();
                                }
                            }
                        }
                        ...
                        public void onFailure(Call<FactResponse> call, Throwable t)
                        {
                            ...
                            Toast.makeText(QuestFActivity.this, t.toString() + "\t" + t.getLocalizedMessage() + "\t" + t.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    });

                } else
                {
                    Toast.makeText(QuestFActivity.this, R.string.no_internet_connection, Toast.LENGTH_SHORT).show();
                }
                return false;
            }
